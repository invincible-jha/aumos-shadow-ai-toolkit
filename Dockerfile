# ============================================================================
# Dockerfile — AumOS Shadow AI Toolkit Service
# Multi-stage build: builder installs deps, runtime runs the service.
# ============================================================================
...
CMD ["uvicorn", "aumos_shadow_ai_toolkit.main:app", "--host", "0.0.0.0", "--port", "8000", "--workers", "2"]
